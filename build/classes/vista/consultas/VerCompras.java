...
import vista.Login;
import vista.Menu;
import vista.inserciones.InsertarCompra;
import vista.modificaciones.ModificarCompra;
...
public class VerCompras extends javax.swing.JFrame {
     ...
     */
    public VerCompras(String nombreUsuario, String rol) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelBienvenido.setText("Compras");
        ...
        jListCompras.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jListCompras.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jListCompras.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jListComprasMouseClicked(evt);
            }
        });
    ...
    private void llenarLista() {
        ...
        dlm = consultas.generarModeloListaCompras();
        jListCompras.setModel(dlm);
    }
    ...
    private void anhadir(){
        InsertarCompra insertarCompra = new InsertarCompra(nombreUsuario, rol);
    ...
    private void eliminar(){
        ...
        //Si decide borrar
        if (opcion == 0) {
            borrados.eliminarCompra(extraerId());
    ...
    private void modificar(){
        ...
        if (jListCompras.getSelectedIndex() > -1) {
            ModificarCompra modificarCompra = new ModificarCompra(nombreUsuario, rol, extraerId());
     ...
     */
    private void jListComprasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jListComprasMouseClicked
        if (jListCompras.getSelectedIndex() > -1) {
    ...
    }//GEN-LAST:event_jListComprasMouseClicked

    private void imprimirInforme(){
        String reportSource = "./src/informes/compras.jrxml";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new VerCompras(nombreUsuario, rol).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList<String> jListCompras;
