...
public class ModificarCliente extends javax.swing.JFrame {
     ...
     */
    public ModificarCliente(String nombreUsuario, String rol, Integer id) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelBienvenido.setText("Modificar cliente");
    ...
    private void aceptar(){
        ...
        if (nombreValido() && dniValido() && telefonoValido() && direccionValida() && codPostalValido()) {
            if (leerTelefono() > 0 && leerCodPostal() > 0) {
                //Modificación de datos
                modificaciones.modificarCliente(id, jTextFieldNombre.getText(), jTextFieldDni.getText(), Integer.parseInt(jTextFieldTelefono.getText()), jTextFieldDireccion.getText(), jTextFieldCiudad.getText(), Integer.parseInt(jTextFieldCodPostal.getText()), convertirImagen());
                limpiarCampos();
            }
        } else {
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        Clientes cliente = consultas.obtenerClienteSegunId(id);
        jTextFieldNombre.setText(cliente.getNombre());
        jTextFieldDni.setText(cliente.getDni());
        jTextFieldTelefono.setText(Integer.toString(cliente.getTelefono()));
        jTextFieldDireccion.setText(cliente.getDireccion());
        jTextFieldCiudad.setText(cliente.getCiudad());
        jTextFieldCodPostal.setText(Integer.toString(cliente.getCodPostal()));
        establecerImagenAlmacenada(cliente.getImagen());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ModificarCliente(nombreUsuario, rol, id).setVisible(true);
            }
        });
    }
