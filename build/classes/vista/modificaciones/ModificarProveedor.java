...
public class ModificarProveedor extends javax.swing.JFrame {
     ...
     */
    public ModificarProveedor(String nombreUsuario, String rol, Integer id) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelBienvenido.setText("Modificar proveedor");
    ...
    private void aceptar(){
        ...
        if (nombreValido() && dniValido() && direccionValida() && webValida() && emailValido() && direccionValida() && codPostalValido() && ciudadValida()) {
            if (leerCodPostal() > 0) {
                //Inserción de datos
                modificaciones.modificarProveedor(id, jTextFieldNombre.getText(), jTextFieldDni.getText(), jTextFieldDireccion.getText(), jTextFieldCiudad.getText(), Integer.parseInt(jTextFieldCodPostal.getText()), convertirImagen(), jSliderValoracion.getValue(), jComboBoxCategoria.getSelectedItem().toString(), jTextFieldWeb.getText(), jTextFieldEmail.getText());
                limpiarCampos();
            }
        } else {
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        Proveedores proveedor = consultas.obtenerProveedorSegunId(id);
        jTextFieldNombre.setText(proveedor.getNombre());
        jTextFieldDni.setText(Integer.toString(proveedor.getIdProveedor()));
        jSliderValoracion.setValue(proveedor.getValoracion());
        jComboBoxCategoria.setSelectedItem(proveedor.getCategoria());
        jTextFieldWeb.setText(proveedor.getSitioWeb());
        jTextFieldEmail.setText(proveedor.getEmail());
        jTextFieldDireccion.setText(proveedor.getDireccion());
        jTextFieldCiudad.setText(proveedor.getCiudad());
        jTextFieldCodPostal.setText(Integer.toString(proveedor.getCodPostal()));
        establecerImagenAlmacenada(proveedor.getImagen());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ModificarProveedor(nombreUsuario, rol, id).setVisible(true);
            }
        });
    }
