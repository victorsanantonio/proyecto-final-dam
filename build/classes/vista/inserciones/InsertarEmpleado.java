...
public class InsertarEmpleado extends javax.swing.JFrame {
     ...
     */
    public InsertarEmpleado(String nombreUsuario, String rol) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelBienvenido.setText("Insertar empleado");
    ...
    private void aceptar(){
        ...
        if (leerCodPostal() > 0 && leerSalario() > 0) {
            if (nombreValido() && apellidosValido() && dniValido() && telefonoValido() && direccionValida() && codPostalValido() && puestoValido() && salarioValido() && usuarioValido() && contrasenhaValida()) {
                //Inserción de datos
                inserciones.guardarEmpleado(jTextFieldNombre.getText(), jTextFieldApellidos.getText(), jTextFieldDni.getText(), formatearFechaNacimiento(), jTextFieldTelefono.getText(), jTextFieldDireccion.getText(), Integer.parseInt(jTextFieldCodPostal.getText()), jTextFieldPuesto.getText(), jComboBoxDepartamentos.getSelectedItem().toString(), Float.parseFloat(jTextFieldSalario.getText()), hombreMujer(), convertirImagen(), jTextFieldUsuario.getText(), jTextFieldContrasenha.getText(), jComboBoxRoles.getSelectedItem().toString(), formatearFechaAlta());
                limpiarCampos();
            }
        } else {
     ...
     * longitud de caracteres permitida por la base de datos
     */
    private boolean salarioValido() {
        if (jTextFieldSalario.getText().length() <= 0) {
            JOptionPane.showMessageDialog(null, "El campo \"Salario\" no puede estar vacío", "Error de introducción de datos", ERROR_MESSAGE);
            return false;
        }
        if (Float.parseFloat(jTextFieldSalario.getText()) < 0) {
            JOptionPane.showMessageDialog(null, "El campo \"Salario\" no puede ser menor que 0", "Error de introducción de datos", ERROR_MESSAGE);
            return false;
        }
        return true;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new InsertarEmpleado(nombreUsuario, rol).setVisible(true);
            }
        });
    }
