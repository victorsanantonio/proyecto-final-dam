...
public class ModificarVenta extends javax.swing.JFrame {
     ...
     */
    public ModificarVenta(String nombreUsuario, String rol, Integer id) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelBienvenido.setText("Modificar venta");
    ...
    private void aceptar(){
        ...
        if (ciudadValida() && direccionValida() && unidadesValido()) {
            ...
            modificaciones.modificarVenta(id, empleado, producto, formatearFecha(), calcularPrecio(), jComboBoxClientes.getSelectedItem().toString(), jLabelDNICliente.getText(), jTextFieldCiudad.getText(), jTextFieldDireccion.getText());
            limpiarCampos();
        } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ModificarVenta(nombreUsuario, rol, id).setVisible(true);
            }
        });
    }
