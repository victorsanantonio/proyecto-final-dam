...
import vista.modificaciones.ModificarProducto;
...
public class VerProductos extends javax.swing.JFrame {
     ...
     */
    public VerProductos(String nombreUsuario, String rol) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jMenuArchivo2 = new javax.swing.JMenu();
        ...
        jLabelBienvenido.setText("Productos");
        ...
        jListProductos.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        ...
        jMenuBar3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N

        jMenuArchivo2.setText("Archivo");
        jMenuArchivo2.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

        jMenuItemGuardar2.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_I, java.awt.event.InputEvent.CTRL_MASK));
        jMenuItemGuardar2.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jMenuItemGuardar2.setText("Imprimir");
        jMenuItemGuardar2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemGuardar2ActionPerformed(evt);
            }
        });
        jMenuArchivo2.add(jMenuItemGuardar2);

        jMenuBar3.add(jMenuArchivo2);
    ...
    private void llenarLista() {
        ...
        dlm = consultas.generarModeloListaProductos();
    ...
    private void anhadir(){
        InsertarProducto insertarProducto = new InsertarProducto(nombreUsuario, rol);
    ...
    private void eliminar(){
        ...
        //Si decide borrar
        if (opcion == 0) {
            borrados.eliminarProducto(extraerId());
    ...
    private void modificar(){
        ...
        if (jListProductos.getSelectedIndex() > -1) {
            ModificarProducto modificarProducto = new ModificarProducto(nombreUsuario, rol, extraerId());
     ...
     */
    private void jMenuItemGuardar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemGuardar2ActionPerformed
        imprimirInforme();
    }//GEN-LAST:event_jMenuItemGuardar2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new VerProductos(nombreUsuario, rol).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JMenu jMenuArchivo2;
