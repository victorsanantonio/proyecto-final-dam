...
import vista.Login;
import vista.Menu;
import vista.inserciones.InsertarCliente;
...
public class VerClientes extends javax.swing.JFrame {
     ...
     */
    public VerClientes(String nombreUsuario, String rol) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelBienvenido.setText("Clientes");
        ...
        jListClientes.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
    ...
    private void llenarLista() {
        ...
        dlm = consultas.generarModeloListaClientes();
    ...
    private void jButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEliminarActionPerformed
        ...
        //Si decide borrar
        if (opcion == 0) {
            borrados.eliminarCliente(extraerId());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new VerClientes(nombreUsuario, rol).setVisible(true);
            }
        });
    }
