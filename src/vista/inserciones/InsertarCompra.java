...
public class InsertarCompra extends javax.swing.JFrame {
     ...
     */
    public InsertarCompra(String nombreUsuario, String rol) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelBienvenido.setText("Insertar compra");
    ...
    private void jButtonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAceptarActionPerformed
        ...
        if (leerCodPostal() > 0) {
            if (codPostalValido() && unidadesValido()) {
                ...
                inserciones.guardarCompra(empleado, producto, formatearFecha(), jComboBoxProveedores.getSelectedItem().toString(), Integer.parseInt(jTextFieldCodPostal.getText()), Float.parseFloat(jLabelTotal1.getText()), Float.parseFloat(jLabelTotalIva1.getText()));
                limpiarCampos();
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new InsertarCompra(nombreUsuario, rol).setVisible(true);
            }
        });
    }
